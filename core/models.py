...
class Startup(models.Model):
    ...
    applicant_last_name = models.CharField(max_length=100, blank=True, null=True)
    applicant_email = models.CharField(max_length=100, blank=True, null=True)
    applicant_phone_no = models.CharField(max_length=13, blank=True, null=True)
