...
from .views import (
    ...
    export_mail_list, MailListView, export_startup_list, export_investor_list, delete_maillist_object
)
...
urlpatterns = [
    ...
    path('admin/mail-list/<pk>/', delete_maillist_object, name="delete_maillist_object")
